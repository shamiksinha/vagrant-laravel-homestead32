...
function embedSWF(sourceSwfName) {
  ...
  if (hasRightVersion) {
    ...
    AC_FL_RunContent('codebase', 'http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,2,0', 'width', '792', 'height', '648', 'src', sourceSwfName, 'quality', 'high', 'pluginspage', 'http://www.adobe.com/go/getflashplayer', 'align', 'middle', 'play', 'false', 'loop', 'false', 'scale', 'noscale', 'wmode', 'window', 'devicefont', 'false', 'id', sourceSwfName, 'bgcolor', '#999999', 'name', sourceSwfName, 'menu', 'true', 'allowFullScreen', 'true', 'allowScriptAccess', 'sameDomain', 'movie', sourceSwfName, 'salign', ''); //end AC code
  } else {
